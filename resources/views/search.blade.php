                                    ...
                                    <div class="f_p_item">
                                        <div class="f_p_img">
                                            ...
                                            <div class="p_icon">
                                                ...
                                                <a href="{{route('add.shopping.cart',$product->id)}}"><i class="lnr lnr-cart"></i></a>
                                            </div>
                                        </div>
                                ...
                                <ul class="list">
                                    @if(isset($categories))
                                        @foreach($categories as $category)
                                            <li>
                                                <a href="{{route('get.list.product',[$category->c_slug,$category->id])}}">{{$category->c_name}}
                                                    <i
                                ...
                                <div class="f_p_item">
                                    <div class="f_p_img">
                                        <a href ="{{route('get.detail.product',[$New->pro_slug,$New->id])}}">
                                            <img class="img-fluid" src="{{pare_url_file($New->pro_avatar)}}" alt=""style="width: 200px;height: 200px">
                                        </a>
                                        <div class="p_icon">
                                            <a href="#"><i class="lnr lnr-heart"></i></a>
                                            <a href="{{route('add.shopping.cart',$New->id)}}"><i class="lnr lnr-cart"></i></a>
                                        </div>
                                    </div>
                                    <a href="{{route('get.detail.product',[$New->pro_slug,$New->id])}}"><h4>{{$New->pro_name}}</h4></a>
                                    <h5>{{number_format($New->pro_price)}}</h5>
                                </div>
                            </div>
                        @endforeach
                    @endif
